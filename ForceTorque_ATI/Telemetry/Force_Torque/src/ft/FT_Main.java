...
public class FT_Main extends JFrame{
	...
	public FT_Main() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
		...
		initComponents();
		this.add(label_devicelist);
		this.add(combobox_devicelist);
		this.add(button_refresh);
		this.add(label_ipaddress);
		this.add(label_speed);
		this.add(checkbox_speed);
		this.add(textfield_ipaddress1);
		this.add(textfield_ipaddress2);
		this.add(textfield_ipaddress3);
		this.add(textfield_ipaddress4);
		this.add(label_port);
		this.add(label_frequency);
		this.add(textfield_port);
		this.add(textfield_frequency);
		this.add(button_connect);
		this.add(button_close);
		this.add(scrollpane_status);
	...
	private void initComponents()
	{
		...
		label_devicelist.setBounds(50,30,150,10);
		combobox_devicelist = new JComboBox<String>();
		combobox_devicelist.setBounds(50, 50, 300, 20);
		button_refresh = new JButton("Refresh...");
		button_refresh.setBounds(360,50,90,20);
		...
		label_ipaddress.setBounds(50,80,150,10);
		label_speed = new JLabel("Speed");
		label_speed.setBounds(250,80,100,10);
		checkbox_speed = new JCheckBox("High Speed");
		checkbox_speed.setBounds(250, 100, 150, 20);
		label_port = new JLabel("Enter Port");
		label_port.setBounds(50,130,150,10);
		label_frequency = new JLabel("Enter Frequency");
		label_frequency.setBounds(150,130,150,10);
		textfield_ipaddress1 = new JTextField();
		textfield_ipaddress1.setBounds(80,100,30,20);
		...
		textfield_ipaddress2.setBounds(120,100,30,20);
		...
		textfield_ipaddress3.setBounds(160,100,30,20);
		...
		textfield_ipaddress4.setBounds(200,100,30,20);
		...
		textfield_port.setBounds(80,150,60,20);
		...
		textfield_frequency.setBounds(160,150,60,20);
		...
		button_connect.setBounds(260,150,90,20);
				...
				try
				{
					if(!textfield_ipaddress1.getText().trim().equals("")&&!textfield_ipaddress2.getText().trim().equals("")&&!textfield_ipaddress3.getText().trim().equals("")&&!textfield_ipaddress4.getText().trim().equals(""))
					{
						...
						if(status == JFileChooser.APPROVE_OPTION)
						{
								...
								int frequency = Integer.parseInt(textfield_frequency.getText().trim());
		...
		button_close.setBounds(360,150,90,20);
		...
		textarea_status.setBounds(50,180,350,120);
		textarea_status.setLineWrap(true);
		scrollpane_status = new JScrollPane(textarea_status);
		scrollpane_status.setBounds(50,180,405,120);
	}
